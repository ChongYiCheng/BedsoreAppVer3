    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        datePicker.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                newFragment.setTargetFragment(SensorFragment1.this, 111); // any number
                        ...
                        query.addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(DataSnapshot dataSnapshot) {
                                for (DataSnapshot ds : dataSnapshot.getChildren()) {
                                    ...
                                    float pressureFloat = ds.child("PValue1").getValue(Float.class);
                                    ...
                                    /*Log.i("TIMESTAMPS", listTimeStamp.toString());
                                    listTime.add(ds.child("Time").getValue().toString());
                                    Log.i("TIME", listTime.toString());*/
